...
import { buildBrandRegistrationData } from '../../../src/utils/registrationData.factory';

test.describe('Brand registration', () => {
  test('registers a new brand through OTP and onboarding', async ({
    registerPage,
    otpPage,
    onboardingPage,
  }) => {
    const data = buildBrandRegistrationData();
